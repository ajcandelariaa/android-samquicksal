        ...
        viewModel.getQrScannedObserver().observe(this, {
            if (it != null){
                if(it.reqStatus == "Invalid Access"){
                    Toast.makeText(applicationContext, "${it.reqStatus}", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(applicationContext, "Customer is already Full Slot", Toast.LENGTH_SHORT).show()
...
//                                viewModel2.getCancelBookInfo(customerId)
                    ...
                    tvQrSRBookType.text = it.bdBookType
                    tvQrSRSlot.text = it.bdAccessSlot.toString()
                    Toast.makeText(applicationContext, "You already sent the request to this customer", Toast.LENGTH_SHORT).show()
                } else {
