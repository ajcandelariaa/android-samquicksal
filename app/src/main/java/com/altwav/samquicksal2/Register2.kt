...
class Register2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnAcceptEula.setOnClickListener {
        ...
        tvEULA.text = "This End-User License Agreement (\"EULA\") is a legal agreement between you and ALTWAV. Our EULA was created by EULA Template for Samquicksal." +
